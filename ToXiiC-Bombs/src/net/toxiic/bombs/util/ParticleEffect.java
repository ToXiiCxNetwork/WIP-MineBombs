    ...
    try
    {
      ...
      else
      {
        ...
        if (v < 1.8D)
        {
          ...
          packetConstructor = packetClass.getConstructor(new Class[] { String.class, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Integer.TYPE });
        }
        else
        {
          ...
          packetConstructor = packetClass.getDeclaredConstructor(new Class[] { enumParticle, Boolean.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Integer.TYPE, int[].class });
        }
      }
    }
    catch (Exception ex)
    ...
    try
    {
      ...
      if (netty)
      {
        if (newParticlePacketConstructor)
        {
          ...
          packet = packetConstructor.newInstance(new Object[] { particleType, Boolean.valueOf(true), Float.valueOf((float)location.getX()), Float.valueOf((float)location.getY()), Float.valueOf((float)location.getZ()), Float.valueOf(this.xoff), Float.valueOf(this.yoff), Float.valueOf(this.zoff), Float.valueOf((float)this.speed), Integer.valueOf(this.count), new int[0] });
        }
        else
        {
          packet = packetConstructor.newInstance(new Object[] { this.type.getName(), Float.valueOf((float)location.getX()), Float.valueOf((float)location.getY()), Float.valueOf((float)location.getZ()), Float.valueOf(this.xoff), Float.valueOf(this.yoff), Float.valueOf(this.zoff), Float.valueOf((float)this.speed), Integer.valueOf(this.count) });
        }
      }
      else
      {
        ...
        for (Field f : fields)
        {
          ...
          if (f.getName().equals("a")) {
            ...
            f.set(packet, Float.valueOf(this.xoff));
          } else if (f.getName().equals("f")) {
            f.set(packet, Float.valueOf(this.yoff));
          } else if (f.getName().equals("g")) {
            f.set(packet, Float.valueOf(this.zoff));
